...
<p>
  <a href="https://github.com/artemhobotun"><img src="docs/assets/profile-icons/github.svg" alt="GitHub" height="34"></a>
  <a href="https://www.linkedin.com/in/artem-nazarko/"><img src="docs/assets/profile-icons/linkedin.svg" alt="LinkedIn" height="34"></a>
  <a href="https://www.credly.com/users/artem-nazarko"><img src="docs/assets/profile-icons/credly.svg" alt="Credly" height="34"></a>
  <a href="https://orcid.org/0000-0002-4190-7288"><img src="docs/assets/profile-icons/orcid.svg" alt="ORCID" height="34"></a>
</p>
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://www.credly.com/badges/58cabc99-a446-46aa-9c0e-346a52071f2e/public_url">
        <img src="docs/assets/credentials/credly/ai-skills-passport.png" width="118" alt="AI Skills Passport">
      </a>
      <br>
    ...
    <td align="center" width="16.66%">
      <a href="https://www.credly.com/badges/193a3f60-2ffd-4e76-a04e-5191cba610aa/public_url">
        <img src="docs/assets/credentials/credly/google-ai-professional-certificate.png" width="118" alt="Google AI Professional Certificate">
      </a>
      <br>
    ...
    <td align="center" width="16.66%">
      <a href="https://www.credly.com/badges/f857b433-a33e-43be-8cfc-5f137335b704/public_url">
        <img src="docs/assets/credentials/credly/legal-ai-leader.png" width="118" alt="Legal AI Leader">
      </a>
      <br>
    ...
    <td align="center" width="16.66%">
      <a href="https://www.credly.com/badges/009c39ee-487c-4b98-a120-6c0d7e8f93e8/public_url">
        <img src="docs/assets/credentials/credly/ai-literacy.png" width="118" alt="AI Literacy">
      </a>
      <br>
    ...
    <td align="center" width="16.66%">
      <a href="https://www.credly.com/badges/70997f1a-7196-4481-a650-81c2d7d9ca45/public_url">
        <img src="docs/assets/credentials/credly/ai-fundamentals-with-ibm-skillsbuild.png" width="118" alt="AI Fundamentals with IBM SkillsBuild">
      </a>
      <br>
    ...
    <td align="center" width="16.66%">
      <a href="https://www.credly.com/badges/456bf973-fc77-4b5b-b2a8-ad6a01e05fa9/public_url">
        <img src="docs/assets/credentials/credly/google-ai-essentials-v1.png" width="118" alt="Google AI Essentials v1">
      </a>
      <br>
...
| I use AI in HR/recruitment | [HR and recruitment](toolkit/sector-packs/hr-and-recruitment.md) | [Legal review escalation guide](docs/guide/16-what-to-escalate-for-legal-review.md) |
...
| I need a documentation pack | [Downloadable toolkit pack](docs/guide/17-downloadable-toolkit-pack.md) | [Evidence pack index](docs/guide/13-evidence-pack-index.md) |
...
| Evidence Pack | You need documentation structure | [docs/guide/13-evidence-pack-index.md](docs/guide/13-evidence-pack-index.md) |
...
| Inventory guide | [docs/guide/04-ai-system-inventory-guide.md](docs/guide/04-ai-system-inventory-guide.md) | Defining what should go into the register |
...
8. Follow the small-company guide: [docs/guide/12-how-to-use-this-toolkit-in-a-small-company.md](docs/guide/12-how-to-use-this-toolkit-in-a-small-company.md)
9. Keep an evidence pack index: [docs/guide/13-evidence-pack-index.md](docs/guide/13-evidence-pack-index.md)
...
- [30-minute self-assessment](toolkit/starter-pack/printable/docs/guide/30-minute-readiness-self-assessment.md)
...
For the full guide, see [docs/guide/05-basic-risk-screening.md](docs/guide/05-basic-risk-screening.md).
...
- Official source register: [docs/guide/14-official-source-register.md](docs/guide/14-official-source-register.md)
- Versioning and maintenance policy: [docs/guide/15-versioning-and-maintenance-policy.md](docs/guide/15-versioning-and-maintenance-policy.md)
- Legal review escalation guide: [docs/guide/16-what-to-escalate-for-legal-review.md](docs/guide/16-what-to-escalate-for-legal-review.md)
- Downloadable toolkit pack: [docs/guide/17-downloadable-toolkit-pack.md](docs/guide/17-downloadable-toolkit-pack.md)
- Glossary: [docs/guide/18-glossary.md](docs/guide/18-glossary.md)
- SME decision tree: [docs/guide/19-sme-decision-tree.md](docs/guide/19-sme-decision-tree.md)
- SME implementation playbook: [docs/guide/20-sme-implementation-playbook.md](docs/guide/20-sme-implementation-playbook.md)
- Common mistakes: [docs/guide/21-common-mistakes.md](docs/guide/21-common-mistakes.md)
- Frequently asked questions: [docs/guide/faq.md](docs/guide/faq.md)
- Maintainer content style guide: [docs/guide/22-maintainer-content-style-guide.md](docs/guide/22-maintainer-content-style-guide.md)
- Source notes: [docs/guide/10-source-notes.md](docs/guide/10-source-notes.md)
- Maintenance process: [docs/guide/11-maintenance-and-review-process.md](docs/guide/11-maintenance-and-review-process.md)
