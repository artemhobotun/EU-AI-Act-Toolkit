...
- If you use third-party AI tools: start with procurement + vendor questionnaire.
- If you build AI features for customers: start with roles (provider/deployer) and inventory + screening.
- If staff uses genAI: start with AI literacy + internal use policy.
