# Internal AI Use Policy (How To Use the Template)
...
- Keep it short. People read policies that fit on a few pages.
...
- Approved tools + prohibited tools
- Data rules (especially personal data and confidential information)
- Human review requirements for high-impact outputs
- Incident reporting and logging
- Exceptions process (who can approve and how it's documented)
