# AI Act Readiness Roadmap (SME-Friendly)

This roadmap is intentionally practical. It helps you organize work and evidence. It does not provide compliance assurance.
...
## Phase 2: Role + Scope Clarity (Week 1-2)

Deliverables:

- For each system/use case, record:
  - Are you mainly a provider, a deployer, or both?
...
Guide: [docs/guide/docs/guide/06-provider-vs-deployer.md](docs/guide/docs/guide/06-provider-vs-deployer.md)

## Phase 3: Basic Screening (Week 2-4)

Deliverables:

- A completed screening form per system/use case:
  - purpose + users + impacted persons
  - data types (personal data, special categories, children)
...
- Start small: cover the top 5 AI use cases that carry the most impact or customer exposure.
- Document decisions, not perfection.
- Keep a clear "stop / pause" rule for unsafe behavior or unexpected outputs.
