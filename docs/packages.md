...
The container is rebuilt automatically on every push to `main` that changes the `Dockerfile` or any file under `docs/`. It can also be triggered manually via the GitHub Actions workflow dispatch.
