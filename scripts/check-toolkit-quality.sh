...
required_files=(
  ...
  "dev/README.md"
  "dev/typescript-toolchain/package.json"
  "dev/typescript-toolchain/package-lock.json"
  "dev/typescript-toolchain/tsconfig.json"
  "dev/typescript-toolchain/vitest.config.ts"
...
check_contains "Dockerfile" "nginx:alpine"
check_contains "Dockerfile" "COPY docs/"
